      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div ref={infoRef} className="space-y-8">
            <div>
              <h3 className="text-2xl font-light text-foreground mb-6">Let's Connect</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">sivaabinesh096@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-secondary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+91 9342397141</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Trichy, Tamil Nadu</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://github.com/SivaAbinesh07" target="_blank" rel="noreferrer" className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                  <GithubLogo size={20} className="text-primary-foreground" />
                </a>
                <a href="https://www.linkedin.com/in/siva-abinesh-s-961425332" target="_blank" rel="noreferrer" className="w-12 h-12 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
                  <LinkedinLogo size={20} className="text-secondary-foreground" />
                </a>
                <a href="https://www.instagram.com/__itz__me__siva__07" target="_blank" rel="noreferrer" className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                  <InstagramLogo size={20} className="text-primary-foreground" />
                </a>
              </div>
            </div>
          </div>
