    ...
    <>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <ElectricBorder color="#3b82f6" speed={2} chaos={0.3} thickness={2} style={{ borderRadius: 8 }}>
                <button
                  onClick={() => scrollToSection('contact')}
                  className="px-6 py-2 bg-black text-white font-bold rounded-lg hover:bg-gray-900 transition-all duration-300"
                >
                  Hire Me
                </button>
              </ElectricBorder>
      ...
      <div ref={mobileMenuRef} className="fixed top-0 right-0 w-full h-full bg-background/95 backdrop-blur-lg z-50 transform translate-x-full md:hidden">
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <h2 className="text-2xl font-light text-primary-glow">Siva Abinesh</h2>
        ...
        <div className="flex flex-col space-y-6 p-6 mt-8">
          ...
          <ElectricBorder color="#3b82f6" speed={2} chaos={0.3} thickness={2} style={{ borderRadius: 8, marginTop: '2rem' }}>
            <button onClick={() => scrollToSection('contact')} className="w-full px-6 py-3 bg-black text-white font-bold rounded-lg hover:bg-gray-900 transition-all duration-300 text-center">
              Hire Me
            </button>
          </ElectricBorder>
        </div>
